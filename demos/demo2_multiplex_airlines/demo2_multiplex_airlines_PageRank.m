...
%
% This script reproduces the extended results in the SI, including Table SM2 and Figure SM2
%
...
%% Define supracentrality parameters
   ...
   multilayer_centrality.centrality_type = 'pagerank';
   multilayer_centrality.omegas = 10.^[-4:.5:2];
...
%% Reproduce Fig. 5 by comparing centralities to node degrees      
   plot_supracentralities_vs_degrees(GC_network_data_filename,w_centrality_datafile,2);
